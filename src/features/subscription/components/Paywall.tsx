...
interface PaywallScreenProps {
  onDismiss?: () => void;
  manageNavigationDismiss?: boolean;
  showCloseButton?: boolean;
}

export const PaywallScreen = ({
  onDismiss,
  manageNavigationDismiss = true,
  ...
  const dismissPaywall = React.useCallback(() => {
    onDismiss?.();
    if (manageNavigationDismiss && navigation.canGoBack()) {
      navigation.goBack();
    }
  }, [manageNavigationDismiss, navigation, onDismiss]);

  useEffect(() => {
    logger.debug('[Paywall] Rendering state snapshot', {
      ...
      manageNavigationDismiss,
      showCloseButton,
    });
  }, [currentOffering, manageNavigationDismiss, showCloseButton]);
