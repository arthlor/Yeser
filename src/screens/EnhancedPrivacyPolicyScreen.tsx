      ...
      <ThemedCard style={styles.card}>
        ...
        <Section title="Bilgilerinizin Güvenliği">
          <Text style={styles.paragraph}>
            ...
            yönteminin herhangi bir müdahaleye veya başka tür bir kötüye
        ...
        <Section title="Bu Gizlilik Politikasındaki Değişiklikler">
          <Text style={styles.paragraph}>
            ...
            yeni Gizlilik Politikasını yayınlayarak herhangi bir değişikliği
            size bildireceğiz. Herhangi bir değişiklik için bu Gizlilik
            Politikasını periyodik olarak gözden geçirmeniz önerilir.
          </Text>
        </Section>
