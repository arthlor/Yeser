...
| 13  | fix_13_delete_gratitude_entry_streak_call.sql | Fixes bad `update_user_streak(uuid)` call in `delete_gratitude_entry_by_date`        | P0       |
| 14  | fix_14_drop_profiles_timezone_check.sql       | Drops auto-named `profiles.timezone` regex CHECK that fix_09 missed                  | P1       |
