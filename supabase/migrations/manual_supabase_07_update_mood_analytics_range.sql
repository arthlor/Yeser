-- Run this in Supabase SQL editor after switching Insights ranges to 15d / 30d / 90d.
-- Without this, the existing get_mood_analytics RPC treats 15d as the fallback branch,
-- which effectively returns 90-day analytics for the 15-day tab.
